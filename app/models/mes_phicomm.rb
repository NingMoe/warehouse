class MesPhicomm
  ...
  def self.print_outside_box_label(label_barcode, sn_array, params)
    zpl_command = "
      ...
      ^FT189,655^A0N,42,40^FH\^FDparams[:net_weight]kg^FS
      ^FT881,488^A0N,42,40^FH\^FD#{pack_qty}PCS^FS
      ^FT876,413^A0N,42,40^FH\^FD#{params{:material_number}}^FS
      ^FT186,408^A0N,42,40^FH\^FD#{params[:model_number]}^FS
      ...
      ^FD>;0130>6ND->5000102>63IH^FS
      ^FT213,491^A0N,42,40^FH\^FD#{params[:mo_number]}C#{params[:carton_number]}^FS
      ^PQ1,0,1,Y^XZ
      ^XA^ID000.GRF^FS^XZ
      ^XA^ID001.GRF^FS^XZ
      ^XA^ID002.GRF^FS^XZ
